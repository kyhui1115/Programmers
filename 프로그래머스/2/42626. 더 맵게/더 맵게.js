class MinHeap {
    ...
    bubbledown() {
        ...
        while((leftChild && leftChild <= this.size()-1 && this.heap[leftChild] < this.heap[parent]) || (rightChild <= this.size()-1 && this.heap[rightChild] < this.heap[parent])){

            if (rightChild && rightChild <= this.size()-1 && this.heap[leftChild] > this.heap[rightChild]){
